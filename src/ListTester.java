...
public class ListTester {
	...
	// THIS IS WHERE YOU CHOOSE WHICH LIST TO TEST
	...
	private void runTests() {
		...
		Integer[] LIST_EMPTYLIST = {};
		String STRING_EMPTYLIST = "";
		...
		testSingleElementList(emptyList_addToRearA_A, "empty_addToRearA_A", LIST_A, STRING_A);
		...
		testEmptyList(A_removeFirst_emptyList, "emptyList_removeFirst");
		...
		testThreeElementList(AB_add0C_CAB, "AB_add0C,CAB", LIST_CAB, STRING_CAB);
		...
		testTwoElementList(ABC_removeB_AC, "ABC_remove_B_AC", LIST_AC, STRING_AC);
